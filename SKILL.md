...
- No final direct atom lacks artifact projection; `design-obligation` and `verification-obligation` atoms must not be treated as `spec-requirement` merely because they are direct.
